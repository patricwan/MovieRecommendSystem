...
object ConnHelper extends Serializable{
  lazy val jedis = new Jedis("10.1.1.100")
  lazy val mongoClient = MongoClient( MongoClientURI("mongodb://10.1.1.100:27017/recommender") )
}
...
object StreamingRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 定义kafka连接参数
    val kafkaParam = Map(
      "bootstrap.servers" -> "10.1.1.95:9092",
