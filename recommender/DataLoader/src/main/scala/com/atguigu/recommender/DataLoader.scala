...
object DataLoader {
  // 定义常
  val MOVIE_DATA_PATH = "/root/github/MovieRecommendSystem/recommender/DataLoader/src/main/resources/movies.csv"
  val RATING_DATA_PATH = "/root/github/MovieRecommendSystem/recommender/DataLoader/src/main/resources/ratings.csv"
  val TAG_DATA_PATH = "/root/github/MovieRecommendSystem/recommender/DataLoader/src/main/resources/tags.csv"

  val MONGODB_MOVIE_COLLECTION = "Movie"
  val MONGODB_RATING_COLLECTION = "Rating"
  val MONGODB_TAG_COLLECTION = "Tag"
  val ES_MOVIE_INDEX = "Movie"
//https://www.cnblogs.com/yanketao/p/10956299.html
  def main(args: Array[String]): Unit = {

    val config = Map(
      "spark.cores" -> "local[*]",
      "mongo.uri" -> "mongodb://10.1.1.100:27017/recommender",
      "mongo.db" -> "recommender",
      "es.httpHosts" -> "10.1.1.100:9200",
      "es.transportHosts" -> "10.1.1.100:9300",
      "es.index" -> "recommender",
      "es.cluster.name" -> "patric-elastic"
    )
    ...
    // 保存数据到ES
    //sstoreDataInES(movieWithTagsDF)
